...
public class MyPrivateProductsFragment extends BaseFragment implements OnCheckedChangeListener{
	private View view;
	private int index;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.activity_rrivate_products, null);
	...
	public void initView() {
		...
		mFragmentList.add(new MyHoldAPrivateFragment());
		mFragmentList.add(new MyPrivatePurchaseRecordsFragment());
		mViewPager = (ViewPager) view.findViewById(R.id.viewpag);
		System.out.println("mViewPager------------>"+mViewPager);
		mRadioGroup = (RadioGroup) view.findViewById(R.id.ra);
		mRadioButton1 = (RadioButton) view.findViewById(R.id.bt_Pu);
		mRadioButton2 = (RadioButton) view.findViewById(R.id.bt_sh);
		mHorizontalScrollView = (LinearLayout) view
				.findViewById(R.id.horizontal);
