...
public class MyFixationFragment extends BaseFragment implements OnCheckedChangeListener{
	private View view;
	private int index;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.actovty_defend_tenaciously, null);
	...
	public void initView() {
		...
		mFragmentList.add(new MySolidChargeFragment());
		mFragmentList.add(new MyPurchaseHistoryFragment());
		mViewPager = (ViewPager) view.findViewById(R.id.viewpager_me);
		System.out.println("mViewPager------------>"+mViewPager);
		mRadioGroup = (RadioGroup) view.findViewById(R.id.rad);
		mRadioButton1 = (RadioButton) view.findViewById(R.id.bt_Purchase_det);
		mRadioButton2 = (RadioButton) view.findViewById(R.id.bt_show_det);
