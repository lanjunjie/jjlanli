...
import com.myfp.myfund.ui.KnowSomeMoneyActivity.LoadHttpsChrome;
import com.myfp.myfund.ui.KnowSomeMoneyActivity.LoadHttpsView;
	...
	public void onReceiveData(ApiType api, String json) {
		...
		try {
			...
			for (int i = 0; i < array.length(); i++) {
				...
				image = jsonObj.getString("ImageURL").substring(2);
