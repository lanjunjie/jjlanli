...
public class SomeGoodsWebActivity extends BaseActivity{
	...
	protected void setContentView() {
		...
		url = "http://www.myfund.com/yeeappay/paypre.aspx?ophone="+mobile+"&osource=APP&ousername="+disp+"&oJiangLi="+form+"&opid=1&op3_Amt="+unt+"&orid=4&op5_Pid="+pid+"&oTuiJianR=";
