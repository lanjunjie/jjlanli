...
public class FundPolingFragment extends BaseFragment implements OnCheckedChangeListener{
	private View view;
	private int index;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.new_activity_query, null);
	...
	public void initView() {
		...
		mFragmentList.add(new DealEntrusFragment());
		mFragmentList.add(new DealHistoryFragment());
		mViewPager = (ViewPager) view.findViewById(R.id.viewpager_query);
		System.out.println("mViewPager------------>"+mViewPager);
		mRadioGroup = (RadioGroup) view.findViewById(R.id.radioqy);
		mRadioButton1 = (RadioButton) view.findViewById(R.id.new_radio_apply);
		mRadioButton2 = (RadioButton) view.findViewById(R.id.new_radio_affirm);
