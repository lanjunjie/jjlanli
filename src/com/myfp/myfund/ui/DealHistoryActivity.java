...
public class DealHistoryActivity extends BaseActivity{
	...
	protected void initViews() {
		// TODO Auto-generated method stub
		setTitle("交易确认查询");
		ed_history_startdate = (EditText) findViewById(R.id.ed_history_startdate);
		ed_history_stopdate = (EditText) findViewById(R.id.ed_history_stopdate);
		findViewAddListener(R.id.bt_history_search);
		findViewAddListener(R.id.bt_history_reset);
		...
		ed_history_startdate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				msg.what = DealHistoryActivity.START_DATAPICK;
				DealHistoryActivity.this.saleHandler.sendMessage(msg);
		...
		ed_history_stopdate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				msg.what = DealHistoryActivity.STOP_DATAPICK;
				DealHistoryActivity.this.saleHandler.sendMessage(msg);
		...
		list_historylist = (ListView)findViewById(R.id.list_history_list);
			...
			if (!(ed_history_startdate.getText().toString() == null)) {
				if (!(ed_history_stopdate.getText().toString() == null)) {
					if (Integer.parseInt(ed_history_startdate.getText()
						...
						execApi(ApiType.GET_HISTORYSEARCH, params);
	...
	class HistorySearchAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			convertView = LayoutInflater.from(DealHistoryActivity.this)
			...
			holder.bt_deal_history.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					// return;
					// }
					Intent intent = new Intent(DealHistoryActivity.this,
							HistoryInforActivity.class);
					Bundle bundle = new Bundle();
					bundle.putString("IDCard", encodeIdCard);
					bundle.putString("PassWord", encodePassWord);
					bundle.putString("YeWu", holder.tv_history_yewu.getText().toString());
	...
	protected Dialog onCreateDialog(int id) {
		...
		case STOP_DIALOG_ID:
			...
			return new DatePickerDialog(this, stopDateSetListener, mYear,
					mMonth,
	...
	Handler saleHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case DealHistoryActivity.START_DATAPICK:

				showDialog(START_DIALOG_ID);

				break;
			case DealHistoryActivity.STOP_DATAPICK:

				showDialog(STOP_DIALOG_ID);
