...
import com.myfp.myfund.ui.ImmediatelyApplyActivity.LoadHttpsChrome;
import com.myfp.myfund.ui.ImmediatelyApplyActivity.LoadHttpsView;
import com.myfp.myfund.utils.DataCleanManager;

public class OpenButtonActivity extends BaseActivity{
	...
	public void onReceiveData(ApiType api, String json) {
		...
		try {
			...
			for (int i = 0; i < array.length(); i++) {
				...
				url = jsonObj.getString("PageURL2"); 
				System.out.println("url+======================>"+url);
				image = jsonObj.getString("ImageURL").substring(1);
